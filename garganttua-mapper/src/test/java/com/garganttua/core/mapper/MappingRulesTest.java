...
class MappingRulesTest {
	...
	private static MappingRules mappingRules;
	...
	static void setUpReflection() throws Exception {
		...
		mappingRules = new MappingRules(reflection);
	}
	...
	void testmappingRuleOnField() throws MapperException {
		...
		List<MappingRule> rules = mappingRules.parse(reflection.getClass(Destination.class));
		...
		assertEquals(Destination.class, rules.get(0).destinationClass().getType());
		...
		assertEquals(Inner.class, rules.get(1).destinationClass().getType());
		...
		assertEquals(Inner.class, rules.get(2).destinationClass().getType());
		...
		assertEquals(Inner.class, rules.get(3).destinationClass().getType());
		...
		assertEquals(Inner.class, rules.get(4).destinationClass().getType());
		...
		assertEquals(Inner.class, rules.get(5).destinationClass().getType());
		...
		assertEquals(Parent.class, rules.get(6).destinationClass().getType());
	}
	
	@Test
	public void testMappingRuleOnObject() throws MapperException {
		List<MappingRule> rules = mappingRules.parse(reflection.getClass(Destination2.class));
	...
	public void testValidate() throws MapperException {
		List<MappingRule> rules = mappingRules.parse(reflection.getClass(CorrectDestination.class));
		assertEquals(1, rules.size());

		assertDoesNotThrow(() -> {
			mappingRules.validate(reflection.getClass(Source.class), rules);
		});

		List<MappingRule> rules2 = mappingRules.parse(reflection.getClass(DestinationWithMappingfromFieldThatDoesntExist.class));
		assertEquals(1, rules2.size());

		MapperException exception = assertThrows( MapperException.class , () -> mappingRules.validate(reflection.getClass(Destination2.class), rules2));

		assertNotNull(exception);

		List<MappingRule> rules3 = mappingRules.parse(reflection.getClass(DestinationWithIncorrectFromMethod.class));
		assertEquals(1, rules3.size());

		MapperException exception2 = assertThrows( MapperException.class , () -> mappingRules.validate(reflection.getClass(Source.class), rules3));
		...
		List<MappingRule> rules4 = mappingRules.parse(reflection.getClass(DestinationWithIncorrectToMethod.class));
		assertEquals(1, rules4.size());

		MapperException exception3 = assertThrows( MapperException.class , () -> mappingRules.validate(reflection.getClass(Source.class), rules4));
		...
		List<MappingRule> rules5 = mappingRules.parse(reflection.getClass(DestinationWithNoToMethod.class));
		assertEquals(1, rules5.size());

		MapperException exception4 = assertThrows( MapperException.class , () -> mappingRules.validate(reflection.getClass(Source.class), rules5));
