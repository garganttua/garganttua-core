...
public interface IBeanProvider extends ILifecycle, Copyable<IBeanProvider>, INativeReflectionConfiguration {
    ...
    /**
     * Queries for a single bean matching the provided definition.
     *
     * <p>
     * This method performs a precise lookup using the complete bean definition,
    ...
    /**
     * Queries for all beans matching the provided definition.
     *
     * <p>
     * This method retrieves all beans that satisfy the criteria specified in the
     * bean definition, allowing for flexible bean discovery and multi-bean injection.
     * </p>
     *
     * @param <T> the bean type
     * @param definition the bean definition to match
