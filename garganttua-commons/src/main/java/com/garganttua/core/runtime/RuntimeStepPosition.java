...
/**
 * Immutable record specifying the relative position for inserting a step within a runtime.
 *
 * <p>
 * RuntimeStepPosition allows precise control over step ordering when building runtimes
 * programmatically using the DSL. Instead of always appending steps at the end,
