 ...
 *
 * <p>
 * {@code IAutomaticBuilder} extends {@link IBuilder} to provide automatic configuration
 * capabilities. When enabled, the builder can detect and apply configurations from
 * various sources (classpath, annotations, conventions) without explicit manual setup.
 * This reduces boilerplate code while maintaining flexibility for manual override.
 * </p>
 *
 * <h2>Usage Example</h2>
 * <pre>{@code
