...
class RuntimeBuilderTest {
    ...
    public void simpleRuntimeBuilderTest() {
        ...
        assertDoesNotThrow(() -> {
            ...
            IDiContextBuilder contextBuilder = DiContext.builder().autoDetect(true).withPackage("com.garganttua.core.runtime");
            ...
            System.out.println(result.prettyDuration());
        });
    ...
    public void testAutoDetectionBuild() throws InterruptedException, ExecutionException {
         ...
         * tasks.add(() -> {
         * IRuntimeResult<String, String> r = runtime.execute("input-" +
