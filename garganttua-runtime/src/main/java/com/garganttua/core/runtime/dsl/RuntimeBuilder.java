        ...
        private void collectStages() {
                ...
                if (address == null)
                        throw new DslException(
                                        "Runtime Definition " + this.objectForAutoDetection.getClass().getSimpleName()
                ...
                stages.entrySet().stream().forEach(e -> {
                        ...
                        IRuntimeStageBuilder<InputType, OutputType> stageBuilder = new RuntimeStageBuilder<>(this,
                                        name, stageName, steps)
                                        .autoDetect(true);
