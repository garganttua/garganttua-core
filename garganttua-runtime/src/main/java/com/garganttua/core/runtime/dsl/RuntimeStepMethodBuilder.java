...
public class RuntimeStepMethodBuilder<ExecutionReturn, StepObjectType, InputType, OutputType> extends
        AbstractMethodArgInjectBinderBuilder<ExecutionReturn, IRuntimeStepMethodBuilder<ExecutionReturn, StepObjectType, InputType, OutputType>, IRuntimeStepBuilder<ExecutionReturn, StepObjectType, InputType, OutputType>, IRuntimeStepMethodBinder<ExecutionReturn, IRuntimeContext<InputType, OutputType>>>
        implements
    ...
    private Integer code = RuntimeStepMethodBinder.GENERIC_RUNTIME_SUCCESS_CODE;

    protected RuntimeStepMethodBuilder(IRuntimeStepBuilder<ExecutionReturn, StepObjectType, InputType, OutputType> up,
    ...
    @Override
    public IRuntimeStepMethodBinder<ExecutionReturn, IRuntimeContext<InputType, OutputType>> build()
            throws DslException {
        ...
        return new RuntimeStepMethodBinder<ExecutionReturn, InputType, OutputType>(binder,
                Optional.ofNullable(this.storeReturnInVariable), this.output, this.code);
    }
